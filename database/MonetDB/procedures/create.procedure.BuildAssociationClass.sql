--DROP PROCEDURE IF EXISTS BuildAssociationClass;

/**
 * This procedure initialises the associationclass table.
 */
CREATE PROCEDURE BuildAssociationClass()
BEGIN

  DELETE FROM associationclass;

  INSERT INTO associationclass 
    (assoc_classid
    ,type
    ,assoc_class
    ,description
    ...
    ( 1000, 1, 'AC1', 'Associated to catalogedsource'),
    ...
    ( 1100, 1, 'AC2', 'Associated to catalogedsource (2sigma)'),
    ...
    ( 1200, 1, 'AC3', 'Associated to catalogedsource (3sigma)'),
    ...
    ( 2000, 1, 'AMC1', 'Associated to multiple catalogedsources'),
    ...
    ( 2100, 1, 'AMC2', 'Associated to multiple catalogedsources (2sigma)'),
    ...
    ( 2200, 1, 'AMC3', 'Associated to multiple catalogedsources (3sigma)'),
