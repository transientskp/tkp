...
DROP DATABASE IF EXISTS pipeline_develop;
 ...
 */
CREATE TABLE assoc_classification (
...
CREATE TABLE cataloguesources (
  ...
  FOREIGN KEY (assoc_class_id) REFERENCES assoc_classification(assoc_classid)
) ENGINE=InnoDB;
...
CREATE TABLE extractedsources (
  ...
  ds_id INT NOT NULL, 
  zone INT NOT NULL, 
  assoc_tau_xtrsrcid INT NULL, 
  assoc_band_xtrsrcid INT NULL, 
  assoc_seq_xtrsrcid INT NULL, 
  assoc_tau_catsrcid INT NULL, 
  assoc_band_catsrcid INT NULL, 
  assoc_seq_catsrcid INT NULL, 
  freq_eff DOUBLE NOT NULL,
  assoc_class_id INT NULL,
  ...
  INDEX(assoc_tau_xtrsrcid),
  INDEX(assoc_band_xtrsrcid),
  INDEX(assoc_seq_xtrsrcid),
  INDEX(assoc_tau_catsrcid),
  INDEX(assoc_band_catsrcid),
  INDEX(assoc_seq_catsrcid),
  FOREIGN KEY (assoc_seq_catsrcid) REFERENCES cataloguesources(catsrcid),
  INDEX (assoc_class_id),
  FOREIGN KEY (assoc_class_id) REFERENCES assoc_classification(assoc_classid)
) ENGINE=InnoDB;
 ...
 * could be associated.
 */
CREATE TABLE assoc_sources (
  associd INT NOT NULL AUTO_INCREMENT,
  seq_nr INT NOT NULL,
  xtrsrcid INT NOT NULL,
  assoc_xtrsrcid INT NOT NULL,
  PRIMARY KEY (associd),
  UNIQUE INDEX (seq_nr
               ,xtrsrcid
               ),
  FOREIGN KEY (xtrsrcid) REFERENCES extractedsources(xtrsrcid),
