...
INSERT INTO versions 
  ...
  ("0.0.1"
  ,(SELECT now())
  ,"/pipe/database/pipeline/MySQL/create.dev_database.sql"
  );
...
CREATE TABLE extractedsources (
  ...
  i_back_tau INT NOT NULL DEFAULT 0,
  i_back_band INT NOT NULL DEFAULT 0,
  i_back_seq INT NOT NULL DEFAULT 0,
  freq_eff DOUBLE NOT NULL,
  assoc_class_id INT NULL,
...
CREATE TABLE assoc_sources (
  ...
  assoc_tau_xtrsrcid INT NOT NULL, 
  assoc_band_xtrsrcid INT NOT NULL, 
  assoc_seq_xtrsrcid INT NOT NULL, 
  PRIMARY KEY (tau
              ,band
              ,seq_nr
              ,xtrsrcid
 ...
 * TODO: Evaluate if it is better to use a function instead of a 
 * procedure
 */
