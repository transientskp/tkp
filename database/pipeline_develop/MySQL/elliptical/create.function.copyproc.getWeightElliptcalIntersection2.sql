DROP FUNCTION IF EXISTS getWeightEllipticalIntersection2;
 ...
 *                 
 */
CREATE FUNCTION getWeightEllipticalIntersection2(ie1_a DOUBLE
                                         ,ie1_b DOUBLE
                                         ,ie2_h DOUBLE
                                         ,ie2_k DOUBLE
                                         ,ie2_a DOUBLE
                                         ...
                                         ,OUT oP3_x DOUBLE
                                         ,OUT oP3_y DOUBLE
                                         ,OUT oc1_angle_0 DOUBLE
                                         ,OUT oc1_angle_1 DOUBLE
                                         ,OUT oc1_angle_2 DOUBLE
                                         ,OUT oc1_angle_3 DOUBLE
                                         ,OUT oc1_theta_0 DOUBLE
                                         ,OUT oc1_theta_1 DOUBLE
                                         ,OUT oc1_theta_2 DOUBLE
                                         ,OUT oc1_theta_3 DOUBLE
                                         ,OUT oe1_theta_0 DOUBLE
                                         ,OUT oe1_theta_1 DOUBLE
                                         ,OUT oe1_theta_2 DOUBLE
                                         ,OUT oe1_theta_3 DOUBLE
                                         ,OUT oe2_a_m_x DOUBLE
                                         ,OUT oe2_a_m_y DOUBLE
                                         ,OUT oe2_b_m_x DOUBLE
                                         ,OUT oe2_b_m_y DOUBLE
                                         ,OUT oe2_P0_vec_x DOUBLE
                                         ,OUT oe2_P0_vec_y DOUBLE
                                         ,OUT oe2_P1_vec_x DOUBLE
                                         ,OUT oe2_P1_vec_y DOUBLE
                                         ,OUT oe2_P2_vec_x DOUBLE
                                         ,OUT oe2_P2_vec_y DOUBLE
                                         ,OUT oe2_P3_vec_x DOUBLE
                                         ,OUT oe2_P3_vec_y DOUBLE
                                         ,OUT oe2_P0_proj_x DOUBLE
                                         ,OUT oe2_P0_proj_y DOUBLE
                                         ,OUT oe2_P1_proj_x DOUBLE
                                         ,OUT oe2_P1_proj_y DOUBLE
                                         ,OUT oe2_P2_proj_x DOUBLE
                                         ,OUT oe2_P2_proj_y DOUBLE
                                         ,OUT oe2_P3_proj_x DOUBLE
                                         ,OUT oe2_P3_proj_y DOUBLE
                                         ,OUT om DOUBLE
                                         ,OUT oc DOUBLE
                                         ,OUT oslope DOUBLE
                                         ,OUT oc2_beta_0 DOUBLE
                                         ,OUT oc2_beta_1 DOUBLE
                                         ,OUT oc2_beta_2 DOUBLE
                                         ,OUT oc2_beta_3 DOUBLE
                                         ,OUT oc2_theta_0 DOUBLE
                                         ,OUT oc2_theta_1 DOUBLE
                                         ,OUT oc2_theta_2 DOUBLE
                                         ,OUT oc2_theta_3 DOUBLE
                                         ,OUT oe2_theta_0 DOUBLE
                                         ,OUT oe2_theta_1 DOUBLE
                                         ,OUT oe2_theta_2 DOUBLE
                                         ,OUT oe2_theta_3 DOUBLE
                                         ,OUT ogeval INT
                                         ,OUT oC1_above BOOLEAN
                                         ,OUT oC2_above BOOLEAN
...
BEGIN
  ...
  DECLARE y1, y2, y3, y4  DOUBLE;
  DECLARE x1, x2, y1_x1, y1_x2, y2_x1, y2_x2, y3_x1, y3_x2, y4_x1, y4_x2 DOUBLE;
  DECLARE x1_arg DOUBLE;
  DECLARE abc_a, abc_b, abc_c, abc_D DOUBLE;
  DECLARE eps_sols DOUBLE DEFAULT 7E-04;
  DECLARE nPoints INT;
  ...
  DECLARE e_area1, e_area2,e_area3,e_area4, e_area, e_triangles, least_e_area DOUBLE;

  DECLARE weight DOUBLE;

  /* output control variables */
  DECLARE oe2_phi DOUBLE;
  DECLARE odistance DOUBLE;
  DECLARE oready BOOLEAN;
  DECLARE odoIntersect BOOLEAN;
  DECLARE oe1_q1 DOUBLE;
  DECLARE oe1_q3 DOUBLE;
  DECLARE oe1_q6 DOUBLE;
  DECLARE oe2_q1 DOUBLE;
  DECLARE oe2_q2 DOUBLE;
  DECLARE oe2_q3 DOUBLE;
  DECLARE oe2_q4 DOUBLE;
  DECLARE oe2_q5 DOUBLE;
  DECLARE oe2_q6 DOUBLE;
  DECLARE oalpha4 DOUBLE;
  DECLARE oalpha3 DOUBLE;
  DECLARE oalpha2 DOUBLE;
  DECLARE oalpha1 DOUBLE;
  DECLARE oalpha0 DOUBLE;
  DECLARE odelta0 DOUBLE;
  DECLARE odelta1 DOUBLE;
  DECLARE odelta2 DOUBLE;
  DECLARE oeta0 DOUBLE;
  DECLARE oeta1 DOUBLE;
  DECLARE ovartheta0 DOUBLE;
  DECLARE oNroots INT;
  DECLARE odoContain BOOLEAN;
  DECLARE oy1_x1 DOUBLE;
  DECLARE oy1_x2 DOUBLE;
  DECLARE oy1 DOUBLE;
  DECLARE oy2_x1 DOUBLE;
  DECLARE oy2_x2 DOUBLE;
  DECLARE oy2 DOUBLE;
  DECLARE oy3_x1 DOUBLE;
  DECLARE oy3_x2 DOUBLE;
  DECLARE oy3 DOUBLE;
  DECLARE oy4_x1 DOUBLE;
  DECLARE oy4_x2 DOUBLE;
  DECLARE oy4 DOUBLE;
  DECLARE onPoints INT;
  DECLARE oQ0_x DOUBLE;
  DECLARE oQ0_y DOUBLE;
  DECLARE oQ1_x DOUBLE;
  DECLARE oQ1_y DOUBLE;
  DECLARE oQ2_x DOUBLE;
  DECLARE oQ2_y DOUBLE;
  DECLARE oQ3_x DOUBLE;
  DECLARE oQ3_y DOUBLE;
  DECLARE oe1_m_0 DOUBLE;
  DECLARE oe1_m_1 DOUBLE;
  DECLARE oe1_m_2 DOUBLE;
  DECLARE oe2_m_0 DOUBLE;
  DECLARE oe2_m_1 DOUBLE;
  DECLARE oe2_m_2 DOUBLE;
  DECLARE oR0_x DOUBLE;
  DECLARE oR0_y DOUBLE;
  DECLARE oR1_x DOUBLE;
  DECLARE oR1_y DOUBLE;
  DECLARE oR2_x DOUBLE;
  DECLARE oR2_y DOUBLE;
  DECLARE oR3_x DOUBLE;
  DECLARE oR3_y DOUBLE;
  DECLARE oP0_x DOUBLE;
  DECLARE oP0_y DOUBLE;
  DECLARE oP1_x DOUBLE;
  DECLARE oP1_y DOUBLE;
  DECLARE oP2_x DOUBLE;
  DECLARE oP2_y DOUBLE;
  DECLARE oP3_x DOUBLE;
  DECLARE oP3_y DOUBLE;
  DECLARE oc1_angle_0 DOUBLE;
  DECLARE oc1_angle_1 DOUBLE;
  DECLARE oc1_angle_2 DOUBLE;
  DECLARE oc1_angle_3 DOUBLE;
  DECLARE oc1_theta_0 DOUBLE;
  DECLARE oc1_theta_1 DOUBLE;
  DECLARE oc1_theta_2 DOUBLE;
  DECLARE oc1_theta_3 DOUBLE;
  DECLARE oe1_theta_0 DOUBLE;
  DECLARE oe1_theta_1 DOUBLE;
  DECLARE oe1_theta_2 DOUBLE;
  DECLARE oe1_theta_3 DOUBLE;
  DECLARE oe2_a_m_x DOUBLE;
  DECLARE oe2_a_m_y DOUBLE;
  DECLARE oe2_b_m_x DOUBLE;
  DECLARE oe2_b_m_y DOUBLE;
  DECLARE oe2_P0_vec_x DOUBLE;
  DECLARE oe2_P0_vec_y DOUBLE;
  DECLARE oe2_P1_vec_x DOUBLE;
  DECLARE oe2_P1_vec_y DOUBLE;
  DECLARE oe2_P2_vec_x DOUBLE;
  DECLARE oe2_P2_vec_y DOUBLE;
  DECLARE oe2_P3_vec_x DOUBLE;
  DECLARE oe2_P3_vec_y DOUBLE;
  DECLARE oe2_P0_proj_x DOUBLE;
  DECLARE oe2_P0_proj_y DOUBLE;
  DECLARE oe2_P1_proj_x DOUBLE;
  DECLARE oe2_P1_proj_y DOUBLE;
  DECLARE oe2_P2_proj_x DOUBLE;
  DECLARE oe2_P2_proj_y DOUBLE;
  DECLARE oe2_P3_proj_x DOUBLE;
  DECLARE oe2_P3_proj_y DOUBLE;
  DECLARE om DOUBLE;
  DECLARE oc DOUBLE;
  DECLARE oslope DOUBLE;
  DECLARE oc2_beta_0 DOUBLE;
  DECLARE oc2_beta_1 DOUBLE;
  DECLARE oc2_beta_2 DOUBLE;
  DECLARE oc2_beta_3 DOUBLE;
  DECLARE oc2_theta_0 DOUBLE;
  DECLARE oc2_theta_1 DOUBLE;
  DECLARE oc2_theta_2 DOUBLE;
  DECLARE oc2_theta_3 DOUBLE;
  DECLARE oe2_theta_0 DOUBLE;
  DECLARE oe2_theta_1 DOUBLE;
  DECLARE oe2_theta_2 DOUBLE;
  DECLARE oe2_theta_3 DOUBLE;
  DECLARE ogeval INT;
  DECLARE oC1_above BOOLEAN;
  DECLARE oC2_above BOOLEAN;
  DECLARE oleast_e_area DOUBLE;
  DECLARE oe_area1 DOUBLE;
  DECLARE oe_area2 DOUBLE;
  DECLARE oe_area3 DOUBLE;
  DECLARE oe_area4 DOUBLE;
  DECLARE oe_area DOUBLE;
  DECLARE oe_triangles DOUBLE;
  DECLARE oweight DOUBLE;
    ...
    CASE Nroots
      ...
      WHEN 2 THEN
        ...
        ELSE
          ...
          ELSE
            SET ogeval = 8;
            /* NOTE: This ogeval = 8 block is an exact copy of the 
             * ogeval = 10 block. The block may be replaced 
             * by the function areaIntersection4P.
             */
            /*+---- TODO: start replacement function areaIntersection4P ----+*
             * SET area = areaIntersection4P(ie1_a
             *                              ,ie1_b
             *                              ,iQ0_x
             *                              ,iQ0_y
             *                              ,iQ1_x
            ...
            /*+---- TODO: end replacement function areaIntersection4P ----+*/
          END IF;
        END IF;
      WHEN 3 THEN
        SET ogeval = 9;
