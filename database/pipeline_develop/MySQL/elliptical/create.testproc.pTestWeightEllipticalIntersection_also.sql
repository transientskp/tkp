...
BEGIN
  ...
  DECLARE cart_distance DOUBLE DEFAULT NULL;
   ...
   */
  SET cart_distance = SQRT(ie2_h * ie2_h + ie2_k * ie2_k);
  SET ocart_distance = cart_distance;
  IF cart_distance > (ie1_a + ie2_a) THEN
  ...
  IF doIntersect = TRUE THEN
    ...
    END IF;
  ELSE
   IF cart_distance <= (ie1_b + ie2_b) THEN
