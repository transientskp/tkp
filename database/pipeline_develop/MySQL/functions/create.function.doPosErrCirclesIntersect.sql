DROP FUNCTION IF EXISTS doPosErrCirclesIntersect;
...
BEGIN
  ...
  /*SET avg_radius = SQRT(1 / (i1ra_err * i1ra_err) + 1 / (i2ra_err * i2ra_err)
                       + 1 / (i1decl_err * i1decl_err) + 1 / (i2decl_err * i2decl_err)
                       );*/
