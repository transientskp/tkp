DROP FUNCTION IF EXISTS getSourceDensityInCat_deg2;
 ...
 */
CREATE FUNCTION getSourceDensityInCat_deg2(icatname VARCHAR(50)
                                        ,itheta DOUBLE
                                        ,ixtrsrcid INT
                                        ) RETURNS DOUBLE
DETERMINISTIC
BEGIN
   ...
   */
  SET caparea = 16200 * (1 - COS(RADIANS(itheta))) / PI();
