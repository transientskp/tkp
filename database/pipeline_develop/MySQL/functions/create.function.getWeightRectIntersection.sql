DROP FUNCTION IF EXISTS getWeightRectIntersection;
 ...
 *+-------------------------------------------------------------------+
 */
CREATE FUNCTION getWeightRectIntersection(i1ra DOUBLE
                                         ,i1decl DOUBLE
                                         ,i1ra_err DOUBLE
                                         ,i1decl_err DOUBLE
                                         ,i2ra DOUBLE
...
BEGIN
  ...
  DECLARE ra_min, ra_max, decl_min, decl_max DOUBLE;
  DECLARE intersection_area, area1, area2, weight DOUBLE;
  ...
  IF dointersect = TRUE THEN
    ...
    SET weight = intersection_area / LEAST(area1, area2);
  ELSE
    SET weight = -1;
  END IF;
