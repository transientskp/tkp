...
/**
 * This functions determines the weight of two intersecting ellipses.
 * If they do not intersect the weight is -1.
 * If they do intersect the weight is the ratio of the intersection area
 * and the area of the smallest ellipse.
 * 
 ...
 * that the x-axis is aligned with the major axis. We will use 
 * ellipse 1's coordinate system as reference frame.
 ...
 *
 * INPUT params:
 *  ie1_a   : the semi-major axis of ellipse 1 [arcsec]
 *  ie1_b   : the semi-minor axis of ellipse 1 [arcsec]
 *  ie2_h   : the x coordinate of the centre of ellipse 2 [arcsec]
 *  ie2_k   : the y coordinate of the centre of ellipse 2 [arcsec]
 *  ie2_a   :
 *  ie2_b   :
 *  ie2_phi : the rotation angle of ellipse 2 [degrees] 
 *            (counterclockwise from +x to +y, i.e. in E1's coord. sys.)
 * OUTPUT params:
 *  weight  : the ratio of the intersection area and the area of the 
 *            smallest ellipse.
 *
 * DEPENDENCIES:
 *  procedures  : GetQuarticRootsAlt()
 *  functions   : areaIntersection2P()
 *                areaLineEllipticalArc()
 *
 *
 * TODO: 
...
BEGIN
  ...
  DECLARE eps_sols DOUBLE DEFAULT 7E-05;
  DECLARE nPoints INT;
   ...
   * whether there is separation or containment.
   */
  ...
  /*TODO: we can use this block for sanity checks at the end:
   * when we might have a weird weight and definite intersection...
  /*IF ready = FALSE THEN
   ...
   * ?TODO? If the ellipses are to close there is intersection 
  ...
  IF (ready = FALSE) THEN
    ...
    /*TODO: set some kind of epsilon in declare section*/
     ...
     * the variable nPoints below will be used
     */
    ...
    CASE Nroots
      ...
      WHEN 2 THEN
        ...
        ELSE
          ...
          IF nPoints = 2 THEN
            SET ogeval = 7;
            /* c1_* is the angle on the circle, 
             * e1_* is the angle in the ellipse
             */
