...
BEGIN
   ...
   */
/*  e1_a := 3600 * GREATEST(ie1_ra_err, ie1_decl_err);
  e1_b := 3600 * LEAST(ie1_ra_err, ie1_decl_err);
  IF ie1_ra_err > ie1_decl_err THEN
    e1_pa := 90;
  ELSE 
    e1_pa := 0;
  END IF;
  e2_a := 3600 * GREATEST(ie2_ra_err, ie2_decl_err);
  e2_b := 3600 * LEAST(ie2_ra_err, ie2_decl_err);
