...
DROP PROCEDURE IF EXISTS pTestDoIntersectElls;

DELIMITER //

CREATE PROCEDURE pTestDoIntersectElls(IN ie1_ra DOUBLE
                               ,IN ie1_decl DOUBLE
                               ...
                               ,OUT oe2_h2 DOUBLE
                               ,OUT oe2_k2 DOUBLE
                               ,OUT odistance1 DOUBLE
                               ,OUT odistance2 DOUBLE
                               ,OUT otofar BOOLEAN
                               ,OUT otoclose BOOLEAN
                               ,OUT ointersect1 BOOLEAN
                               ,OUT oready1 BOOLEAN
                               ,OUT ointersect2 BOOLEAN
                               ,OUT oready2 BOOLEAN
...
BEGIN
  ...
  /* If we determine on basis of the centres of the 
   * ellipses and their major and minor axes if they
   * are to far or overlap we are ready
   */
  ...
  SET odistance1 = distance;
  SET otofar = tofar;
  SET ointersect1 = intersect;
  SET oready1 = ready;
  ...
  SET odistance2 = distance;
  SET otoclose = toclose;
  SET ointersect2 = intersect;
  SET oready2 = ready;
