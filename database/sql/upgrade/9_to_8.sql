...
ALTER TABLE IMAGE ADD COLUMN centre_ra DOUBLE DEFAULT NULL; %SPLIT%
ALTER TABLE IMAGE ADD COLUMN centre_decl DOUBLE DEFAULT NULL; %SPLIT%
ALTER TABLE IMAGE ADD COLUMN x DOUBLE DEFAULT NULL; %SPLIT%
ALTER TABLE IMAGE ADD COLUMN y DOUBLE DEFAULT NULL; %SPLIT%
ALTER TABLE IMAGE ADD COLUMN z DOUBLE DEFAULT NULL; %SPLIT%
