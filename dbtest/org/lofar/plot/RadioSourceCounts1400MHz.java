...
public class RadioSourceCounts1400MHz extends ApplicationFrame {

    public RadioSourceCounts1400MHz(String title) {
        super(title);
	...
	System.out.println("i \t S \t\t sum \t\t y" /*\t\t Nfirst \t\t Nsecond \t\t N\t\t"*/);
	System.out.println("-------");
        while (S <= Smax) {
    ...
    public static void main(String[] args) {
        ...
        RadioSourceCounts1400MHz demo = new RadioSourceCounts1400MHz("Pipeline processing times");
        demo.pack();
