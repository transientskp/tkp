...
public class SexErrorsRun04 extends ApplicationFrame {

	private final static String runid = "run04";
	private final static String characteristics = "(5\u03c3)";
	private final static String lofarTable = "lofarcatrun04";

	// Histogram
	public SexErrorsRun04(SimpleHistogramDataset shdataset, String title) {
        	super(title);
	...
	// XYDataset
        public SexErrorsRun04(XYDataset dataset, String title, String type) {
                super(title);
	...
	private static JFreeChart createChart(SimpleHistogramDataset dataset) {
		...
		if ("F".equals(type)) {
			title = "SExtractor results on Flux Errors for " + runid + " " + characteristics;
	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
		        SexErrorsRun04 demo2 = new SexErrorsRun04(ds, "Plot on Flux Errors", "F");
		        demo2.pack();
