...
description = 'GRB030329 GMRT 1280MHz flux test'
...
for file in files:
    if (
        file == 'GRB030329_GMRT_1280_20060727.fits' 
        or file == 'GRB030329_GMRT_1280_20071116.fits' 
        ):
        ...
        imid = my_image.id[0]
        print "Image Id:", imid
        results = my_image.extract(det=10,anl=6)
