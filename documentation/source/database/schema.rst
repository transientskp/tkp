...
**freq_eff** 
    The effective frequency (in Hz) at which the observation was carried out. Value originates from image header file. NOTE: In the case of FITS files the header keywords representing the effective frequency are not unique and may differ. See _freqparse() in tkp.utility.accessors.fitsimage.py.
...
**centre_ra** and **centre_decl**
	The central coordinates (J2000) of the image in degrees. Values originate from image header. Not yet stored in table.

**x**, **y** and **z**
    The Cartesian coordinates of centre_ra and centre_decl. Values are calculated from ra and decl. Not yet stored in table.
