...
basedir = '/home/scheers/simsa/posflux/mJy_3maps1000/'
...
logfile = basedir + '../tkplog/' + db_type + '_' + db_dbase + '_' + logtime + '.log'
log = open(logfile, 'w')
#log.write('-')
...
try:
    ...
    description = 'Test TRAPD: LOFAR images 130 MHz'
    ...
    for file in files:
        ...
        if (file.startswith('SOURCESINSERTED') ):
            if i < 10:
                ...
                dbu.variabilityDetection(conn, dataset.id, 0.2, 3.0)
