...
public class HistoProcTimes extends ApplicationFrame {

	private static XYSeriesCollection ds;

	public HistoProcTimes(String title) {
        	super(title);
		...
		d1.addSeries("S1", values, 5);
		double[] values2 = {2.0, 4.0, 6.0, 8.0, 12.0, 24.0, 10.0, 12.6, 9.0};
		//d1.addSeries("S2", values2, 5);
		SimpleHistogramDataset dataset = new SimpleHistogramDataset("Series 1");
	        ...
	        JFreeChart chart = createChart(d1);
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("bins: " + bn1 + "; " + bn2 + "; " + bn3 + "; " + bn4 + "; " + 
		        ...
		        HistoProcTimes demo = new HistoProcTimes("Input vs. SExtractorRA");
		        demo.pack();
