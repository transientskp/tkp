...
public class SexErrorsRun01 extends ApplicationFrame {

	private final static String runid = "run01";

	public SexErrorsRun01(SimpleHistogramDataset shdataset, String title) {
        	super(title);
        ...
        public SexErrorsRun01(XYDataset dataset, String title, String type) {
                super(title);
	...
	private static JFreeChart createChart(SimpleHistogramDataset dataset) {
		...
		if ("F".equals(type)) {
			title = "SExtractor results on Flux Errors for " + runid;
			x_axis = "True flux (in Jy)";
			y_axis = "Flux Error (Measured - True)";
		}
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 0; i < numberOfBins; i++) {
				...
				//System.out.println("Regelnr in file: " + lineNr);
					...
					if (sign.equals("-")) d1 = d1 * -1;
                                        ...
                                        String sel = getQuery("lofarcatrun01", f1, time1);
					...
					rs = st.executeQuery(getQuery("lofarcatrun02", f1, time1));
					records = 0;
					while (rs.next()) {
						a2 = rs.getDouble(1);
						d2 = rs.getDouble(2);
			...
			/*
		        SexErrorsRun01 demo1 = new SexErrorsRun01(asds, "Plot on Position Error w/ FLUX_MAX", "P");
		        demo1.pack();
		        RefineryUtilities.centerFrameOnScreen(demo1);
		        demo1.setVisible(true);
			*/
		        SexErrorsRun01 demo2 = new SexErrorsRun01(ds, "Plot on Flux Errors - 4\u03c3, 150px MINAREA", "F");
		        demo2.pack();
		        RefineryUtilities.centerFrameOnScreen(demo2);
		        demo2.setVisible(true);
			/*
		        SexErrorsRun01 histodemo1 = new SexErrorsRun01(shds1, "Histogram on Position Error w/ FLUX_MAX J2000");
		        histodemo1.pack();
