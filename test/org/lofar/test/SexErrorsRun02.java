...
public class SexErrorsRun02 extends ApplicationFrame {

	private final static String runid = "run02";

	// Histogram
	public SexErrorsRun02(SimpleHistogramDataset shdataset, String title) {
        	super(title);
	...
	// XYDataset
        public SexErrorsRun02(XYDataset dataset, String title, String type) {
                super(title);
	...
	public static void main(String[] args) {
		...
		try {
			...
			for (int i = 0; i < numberOfBins; i++) {
				...
				//System.out.println("Regelnr in file: " + lineNr);
					...
					if (sign.equals("-")) d1 = d1 * -1;
                                        ...
                                        String sel = getQuery("lofarcatrun02", f1, time1);
			...
			*/
		        SexErrorsRun02 demo2 = new SexErrorsRun02(ds, "Plot on Flux Errors - 4\u03c3, 150px MINAREA", "F");
		        demo2.pack();
