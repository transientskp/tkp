...
public class SexErrorsRun03 extends ApplicationFrame {

	private final static String runid = "run03";
	private final static String characteristics = "(7\u03c3)";
	private final static String lofarTable = "lofarcatrun03";

	// Histogram
	public SexErrorsRun03(SimpleHistogramDataset shdataset, String title) {
        	super(title);
	...
	// XYDataset
        public SexErrorsRun03(XYDataset dataset, String title, String type) {
                super(title);
	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
		        SexErrorsRun03 demo2 = new SexErrorsRun03(ds, "Plot on Flux Errors", "F");
		        demo2.pack();
