...
""" + ",".join(values)
    ...
    # Be aware that the replace statement only works if we don't insert
    # strings that contain a substring None. That's what we have.
